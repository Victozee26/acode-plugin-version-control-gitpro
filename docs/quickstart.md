# Quickstart: use source control in Acode

Get up and running with Git in Acode Editor in minutes. This guide covers the essentials of setting up a repository, saving your changes, and syncing your code.

## Prerequisites

1. **Install Git**: make sure Git is installed on your system. [Download Git](https://git-scm.com/downloads)

1. **Open Acode**: make sure you have the latest version of [Acode](https://github.com/Acode-Foundation/Acode/releases) installed.
...
Clone a repository if you want to work on code that is already hosted on GitHub, Azure DevOps, or another Git provider. If you have previously cloned the repository, you can open the folder directly in Acode and Acode Git SCM will detect the Git repository automatically.

To clone a repository in Acode:

1. Open the Source Control view and select **Clone Repository**
   ...
   Alternatively, open the Command Palette (`ctrl+shift+p`) and enter `Git: Clone`

1. Enter the repository URL (for example, `https://github.com/Acode-Foundation/Acode`)
...
1. Select a parent folder on your system to save the project
...
1. Open your project folder in Acode (**Open Folder**).

1. Open the Source Control view and select **Initialize Repository**
   ...
   Alternatively, open the Command Palette (`ctrl+shift+p`) and enter `Git: Initialize Repository`.

## Step 2: Make changes and review

Git tracks changes to files in your project. The Source Control view in Acode is your hub for managing these changes without using the command line.
...
1. To review the changes to a file, select it in the Source Control view to open a diff editor.
   ...
   A diff editor shows the differences between the current version of the file and the last committed version. The changes are shown inline.

   ![Screenshot of the Diff Editor showing Unified Diff changes between file versions.](images/quickstart/diff-editor.png)
...
1. To stage your changes, do one of the following:
   - Click and hold a file in the **Changes** list and select **Stage Change**s to stage it

     ![Screenshot of the Source Control view with the Stage Changes menu.](images/quickstart/stage-changes-menu.png)

   - Click and hold the **Changes** header and select **Stage All Changes** to stage all changes at once

1. (Optional) You can unstage changes or discard changes if needed:
   - To unstage a file, click and hold it in the **Staged Changes** list and select **Unstage Changes**

   - To discard changes to a file, click adn hold it in the Changes list and select **Discard Changes**
...
1. To view your commit history, select **History** menu in the Source Control view, or open the Command Palette (`Ctrl+Shift+P`) and enter `Git: History`.

   ![Screenshot of the Source Control History.](images/quickstart/history.png)
...
1. To pull or push individually, select the more menu (⋮) in the Source Control view and choose **Pull** or **Push**.

   ![Screenshot of the Pull and Push commands in the Source Control view more menu.](images/quickstart/pull-push-commands.png)
...
- [Source Control Overview](/docs/overview.md) - Full reference for source control features.
